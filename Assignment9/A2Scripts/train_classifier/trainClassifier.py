...
def extractFeedInformation(settings,categorizedDat=None):
	# Get data from feeds
	data = feedparser.parse('../newsfeeds/sportsWorldNews/rssfeed')
	print('Test')
...
def train_classifier(settings,trainingData):
	...
	for key in trainingData.keys():
		...
		print('Error test' + trainingData[key]['description'] + ' ' + trainingData[key]['category'])
...
if __name__ == '__main__':
	...
	trainingDataFile = 'key.txt'
	allCategories = 'keyTotal.txt'
